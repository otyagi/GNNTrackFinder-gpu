...
export MY_BUILD_DIR=/home/evovch/cbmroot/build
cd $MY_BUILD_DIR
. ./config.sh
cd -
...
analyze_run_directory outputRootFileWithHist.root /home/evovch/cbmroot/trunk/macro/rich/prototype/beamtime/NewUnpacker/pics/ titleOfAnalysis /store/cbm_rich_data_2014/WLS/WLS_off/nonstretched/ringA1/offset00250/
