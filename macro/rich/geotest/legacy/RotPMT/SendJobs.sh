...
OnBatch=0
if [ $ComputingPlace == 2 ];then OnBatch=1; fi
...
###########################################
extendedmir=1; GeoCase=2; DimCase=2
OldCode=1
###########################################
