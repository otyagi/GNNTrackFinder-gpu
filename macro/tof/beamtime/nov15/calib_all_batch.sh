...
echo Processing calib_all_batch at I=$I for Run $RunId, CalSet $CalSet, Sel2 $Sel2
...
cd  ${wdir}
source ./init_calib.sh CbmTofSps_${RunId} ${CalSet}

cd  ${wdir}
source ./iter_calib.sh CbmTofSps_${RunId} ${CalSet} ${Sel2}

cd  ${wdir}
source ./gen_digi.sh CbmTofSps_${RunId} ${CalSet} ${Sel2}

mv -v ${SGE_STDOUT_PATH} ${outdir}/Calib_CbmTofSps_${RunId}_${CalSet}_${Sel2}.log
