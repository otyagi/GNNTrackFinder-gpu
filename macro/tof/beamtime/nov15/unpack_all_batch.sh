...
echo Processing unpack_all_batch at I=$I for Run $RunId

wdir=/hera/cbm/users/nh/CBM/cbmroot/trunk/macro/tof/beamtime/nov15
outdir=/hera/cbm/users/nh/CBM/cbmroot/trunk/macro/tof/beamtime/nov15/CbmTofSps_${RunId}
mkdir ${outdir}
...
root -b -q '../unpackCalib.C("CbmTofSps_'${RunId}'")'
mv  -v  ./TofTdcCalibHistos_Tof_calib_batch.root ./TofTdcCalibHistos_CbmTofSps_${RunId}.root
cp  -v  ./TofTdcCalibHistos_CbmTofSps_${RunId}.root ../
ln  -s  ./TofTdcCalibHistos_CbmTofSps_${RunId}.root ./TofTdcCalibHistos_batch.root

root -b -q '../unpackRun.C("CbmTofSps_'${RunId}'")'
rm ./TofTdcCalibHistos_Tof_calib_batch.root
cp ./tofMbsCal.hst.root ./tofMbsCal_${RunId}.hst.root
cp ./tofMbsCal_${RunId}.hst.root ../
fi

if((1)); then
root -b -q 'create_calib.C(10000000000,"CbmTofSps_'${RunId}'")'
root -b -q 'apply_calib.C(10000000000,"CbmTofSps_'${RunId}'")'
fi
mv -v ${SGE_STDOUT_PATH} ${outdir}/unpack_${RunId}.out
