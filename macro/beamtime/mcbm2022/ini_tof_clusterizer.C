                         ...
                         Double_t dDeadtime = 50, TString cCalId = "XXX", TString parPath = "")
{
  ...
  tofClust->SetModifySigvel(0.8);  //extension of strip length beyond HV electrode in cm
  ...
  // disable bad channels in 2022 data
  tofClust->SetDeadStrips(15, 4194304);     // declare dead strip for TMR 030,Strip 23
  tofClust->SetDeadStrips(22, 4);           // declare dead strip for TMR 042,Strip 2
  tofClust->SetDeadStrips(23, 65536);       // declare dead strip for TMR 043,Strip 17
  tofClust->SetDeadStrips(28, 268435456);   // declare dead strip for TMR 203,Strip 28
  tofClust->SetDeadStrips(31, 2147483648);  // declare dead strip for TMR 600,Strip 31
  //tofClust->SetDeadStrips(34,25);   // declare dead strip for TMR 701,Strip 25
  //tofClust->SetDeadStrips(36,25);   // declare dead strip for TMR 901,Strip 3

  if (calMode > 99 || calMode % 10 == 1 || calMode % 10 == 2) calMode = 93;
